export default {
    settings: {
      ...
      scheduling: {
        ...
        stickyOverflowSlotsTitle: '粘性会话并发溢出槽位',
        stickyOverflowSlotsDescription: '粘性会话命中的账号槽位已满时，允许在「账号并发上限 + N」下再抢一次槽位，抢到就立刻转发、不进入粘性排队；抢不到才回落到原有排队/换号逻辑。0 = 关闭，最大 5。仅对粘性命中的账号生效，普通选号仍受账号并发上限约束。',
        stickyOverflowSlotsWarning: '并发上限的作用是保护上游。放宽会提高触发上游 429/限流的概率，建议从 1 开始观察。',
