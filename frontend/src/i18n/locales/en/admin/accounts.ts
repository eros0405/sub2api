export default {
    accounts: {
      ...
      promptPresetLabel: 'Test prompt',
      promptPresetDefault: 'Default ("hi")',
      promptPresetCutoff: 'Ask knowledge cutoff',
      promptPresetCustom: 'Custom',
      customPromptLabel: 'Custom prompt',
      customPromptPlaceholder: 'Enter a custom test prompt',
