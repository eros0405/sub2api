...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// 上游5xx错误率熔断配置
		adminSettings.GET("/upstream-5xx-breaker", h.Admin.Setting.GetUpstream5xxBreakerSettings)
		adminSettings.PUT("/upstream-5xx-breaker", h.Admin.Setting.UpdateUpstream5xxBreakerSettings)
		...
		// 面板 IP 白名单
		adminSettings.GET("/panel-ip-whitelist", h.Admin.Setting.GetPanelIPWhitelistSettings)
		adminSettings.PUT("/panel-ip-whitelist", h.Admin.Setting.UpdatePanelIPWhitelistSettings)
		// 流超时处理配置
